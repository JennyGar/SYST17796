...
public class BlackjackPlayer extends Player {
    ...
    // 21 and 20 are just placeholder until method for counting hand is entered
    public void declareWinner() {
        if (21 > 20) {
            winBet();
            System.out.print(getPlayerID() + ", you won!");
        } else {
            loseBet();
            System.out.print(getPlayerID() + ", you lost!");
        }
    }
    
    public void winBet() {
        this.chips.addAll(this.chipsBet);
        Collections.sort(this.chips);
    }
    
    public void loseBet() {
        chips.removeAll(this.chipsBet);
        Collections.sort(this.chips);
    }
